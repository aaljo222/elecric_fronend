...
// React 동적 직각삼각형 컴포넌트 예시
const RightTriangleQuiz = ({ base, height, hypotenuse, angleLabel }) => (
  <svg viewBox="0 0 200 150" className="w-64 h-48 drop-shadow-md">
    {/* 삼각형 그리기 */}
    <polygon
      points={`20,130 180,130 180,${130 - height * 20}`}
      fill="none"
      stroke="#0ea5e9"
      strokeWidth="3"
    />
    {/* 직각 표시 */}
    <polyline
      points="165,130 165,115 180,115"
      fill="none"
      stroke="#64748b"
      strokeWidth="2"
    />
    ...
    <text x="50" y="125" className="fill-rose-400 font-bold italic">
      {angleLabel}
    </text>
  </svg>
);
