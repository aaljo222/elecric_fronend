...
const PresentationIndexPage = () => {
  ...
  const subjects = [
    ...
    { code: "CN", title: "제어공학", color: "orange", icon: "🎛️" }, // 👈 추가됨
  ...
  const fetchChapterList = async () => {
    ...
    try {
      const res = await fetch(
        `${API_BASE}/api/presentation/chapters/list?subject=${selectedSubject}`,
      );
  ...
  const handleChapterClick = (chapter) => {
    navigate(`/presentation/${selectedSubject.toLowerCase()}/${chapter.code}`);
  };
