...
const MathFraction = ({
  ...
  return (
    <div className="flex items-center text-base lg:text-lg font-medium text-gray-700 bg-white px-4 py-3 rounded-lg border border-gray-200 shadow-sm overflow-hidden">
...
const YDeltaConverterWidget = () => {
  ...
  return (
    // 💡 h-full을 제거하여 모달 안에서 자연스럽게 스크롤 되도록 수정했습니다.
